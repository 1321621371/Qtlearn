#ifndef _MMCWRAPPER_H_
#define _MMCWRAPPER_H_
...
#define LOGE(...) fprintf(stdout, "E RPMB: " __VA_ARGS__)
#define LOGW(...) fprintf(stdout, "W RPMB: " __VA_ARGS__)
#define LOGI(...) fprintf(stdout, "I RPMB: " __VA_ARGS__)
#define LOGD(...) fprintf(stdout, "D RPMB: " __VA_ARGS__)

#ifdef RPMB_DEBUG
#define LOGV(...) fprintf(stdout, "V RPMB: " __VA_ARGS__)
#else
#define LOGV(...)
#endif

#define CHECK(expr, msg, err_stmt) { if (expr) { LOGE(msg); err_stmt; } }
